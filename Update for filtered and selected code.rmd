...
env_chem_L2012 <- read_csv("https://www.epa.gov/sites/production/files/2016-12/nla2012_waterchem_wide.csv")
env_algal_L2012 <- read_csv("https://www.epa.gov/sites/production/files/2016-11/nla2012_algaltoxins_08192016.csv")
env_chloro_L2012 <- read_csv("https://www.epa.gov/sites/production/files/2016-11/nla2012_chla_wide.csv")
env_atrazine_L2012 <- read_csv("https://www.epa.gov/sites/production/files/2016-11/nla2012_atrazine_08192016.csv")
phys_hab_L2012 <- read_csv("https://www.epa.gov/sites/production/files/2016-12/nla2012_wide_phab_08232016_0.csv")
```
```{r}
phys_hab_L2012 <- read_csv("https://www.epa.gov/sites/production/files/2016-12/nla2012_wide_phab_08232016_0.csv")
View(phys_hab_L2012)
